export type Tab = 'dashboard' | 'create' | 'import' | 'unlock' | 'send' | 'tokens' | 'wallets' | 'fdawallets' | 'hold-fda' | 'metamask' | 'p2p' | 'trade-listing' | 'admin' | 'disputes' | 'history' | 'profile' | 'charts' | 'payment-methods' | 'view-phrases';
